...
// Pin diff formatting so user gitconfig cannot change the paths parseGitDiff reads.
// Callers append the revision under review; old Git versions ignore unknown -c keys.
