...
describe('selectReviewPlaybookIds', () => {
  ...
  it('does not match frontend keywords buried inside a larger word', () => {
    ...
    for (const file of [
      ...
      'libs/modules/src/agent-view/config/agent-view.config.spec.ts',
      'libs/modules/src/agent-view/repository/read-agent-view.repository.ts',
      'libs/modules/src/agent-view/repository/write-agent-view-runtime-session.repository.spec.ts',
      'libs/modules/src/agent-view/service/agent-view-product.service.ts',
      'apps/core-ledger/src/agent-view/browser/agent-view-browser.api-spec.ts',
  ...
  it('still matches genuine frontend files (boundary keywords, hooks, .tsx)', () => {
    for (const file of [
      ...
      'src/login-form.ts',
      'src/account-view.ts',
      'src/account.view.test.ts',
      'src/account-view.spec.ts',
      'src/views/account-state.ts',
