...
| `verify-findings`         | `true`             | All findings, including P3 and nits, are adversarially re-checked before posting, with blocking findings first. Refuted findings are dropped; uncertain candidates remain in diagnostics and are withheld from PR comments, except up to two concrete P0–P2 findings a run whose verification returned no verdict, which post labeled Unverified.                                                                                                                                                                                                                                                                                                           |
...
unattempted check. Both remain withheld from PR findings, except the two
unchecked concrete P0–P2 findings a run posted labeled Unverified.
...
notice. They still prevent automatic approval and an all-clear result. One
exception: up to two concrete P0–P2 findings a run whose verification returned
no verdict post labeled Unverified, outside the severity counts. This rule
...
the candidate location. Uncertain verdicts and any other provider or budget
