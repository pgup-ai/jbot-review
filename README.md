...
Once every finding in a review is represented by a resolved thread, a later run
compacts that review's stale summary and keeps the original body under a disclosure.
