...
| `@symma/protocol` (npm)             | ACP engine: framing, JSON-RPC peer, session driving, read-only permission floor, agent specs and their credential helpers. Extracted from this repo; the local copies are gone |
