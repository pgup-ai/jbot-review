...
| `src/shared/acp-protocol.ts`        | ACP engine: framing, JSON-RPC peer, session driving, read-only permission floor, agent specs. Imports nothing review-related — the boundary a gateway/companion package would extract along |
